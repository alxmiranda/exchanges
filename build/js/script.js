...
var _vueResource = require('../../node_modules/vue-resource/dist/vue-resource');

var _vueResource2 = _interopRequireDefault(_vueResource);

var _listingExchanges = require('./listingExchanges');
...
var urlApi = "https://gist.githubusercontent.com/alxmiranda/cb10903d71abe28c4b8f4dadc73153de/raw/a62e52a29c64ea32935689efd4871743afd6ad54/data.json";
  ...
  created: function created() {
    ...
    this.$http.get(urlApi).then(function (response) {
      response.json().then(function (data) {
        var list = new _listingExchanges2.default(data.ticker_1h.exchanges);
...
var listingExchanges = function () {
  function listingExchanges(data) {
    _classCallCheck(this, listingExchanges);
